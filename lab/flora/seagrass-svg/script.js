(function(){
    ...
    // const svg = document.querySelector('.plantcard svg');
    // let vpHeight;
    // let vpWidth;
    // let stalks;
    // let stalkMin;
    ...
    //     }
    //     vpWidth = svg.offsetWidth;
    //     vpHeight = svg.offsetHeight;
    //     stalks = density;
    //     stalkMin = vpHeight / 6;
    //     stalkMax = vpHeight / 3;
    ...
    //                 svg.querySelector(`.gen${j - 1}.stalk${i}`).appendChild(newSeg);
    //             } else {
